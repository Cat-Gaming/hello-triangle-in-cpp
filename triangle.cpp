...
bool init_resources(void)
{
    ...
    {
        std::cerr << "Could not bin attribute " << attribute_name << std::endl;
        return false;
    }
...
int main(int argc, char* argv[])
{
    ...
    {
        std::cerr << "Error glew not Initalized!" << std::endl;
        return EXIT_FAILURE;
    }
    ...
    std::cout << glGetString(GL_VENDOR) << " " << glGetString(GL_VERSION) << std::endl;
